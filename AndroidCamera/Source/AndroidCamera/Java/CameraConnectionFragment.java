...
public class CameraConnectionFragment extends Fragment {
  ...
  public static final String TAG = "CameraConnectionFragment";
  /**
  ...
  private void setUpCameraOutputs() {
    ...
    try {
      ...
      final String errorMsg = "Camera2API not supported";
  ...
  private void configureTransform(final int viewWidth, final int viewHeight) {
    final Activity activity = getActivity();
    if (null == surfaceTexture || null == previewSize || null == activity) {
      return;
    }
    ...
    // TODO(dostos): Set transform of what?
  }
