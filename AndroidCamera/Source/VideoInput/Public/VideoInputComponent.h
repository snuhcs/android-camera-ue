...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnFrameAvailableDelegateDynamic, const UAndroidCameraFrame*, CameraFrame);
DECLARE_MULTICAST_DELEGATE_OneParam(FOnFrameAvailableDelegate, const UAndroidCameraFrame*);
...
public:
	...
	void Initialize(FString path, int w, int h, int totalFrameCnt, int blockFrameCnt, int buffFrameCnt, float remainingPercent, int64 frameDuration);
