...
DECLARE_STATS_GROUP(TEXT("AndroidCamera"), STATGROUP_AndroidCamera,
                    STATCAT_Advanced);

DECLARE_CYCLE_STAT_EXTERN(TEXT("YUV420toARGB"), STAT_AndroidCameraYUV420toARGB,
                          STATGROUP_AndroidCamera, ANDROIDCAMERA_API);
DECLARE_CYCLE_STAT_EXTERN(TEXT("ARGBtoTexture2D"),
                          STAT_AndroidCameraARGBtoTexture2D,
                          STATGROUP_AndroidCamera, ANDROIDCAMERA_API);
DECLARE_CYCLE_STAT_EXTERN(TEXT("CopyBuffer"), STAT_AndroidCameraCopyBuffer,
                          STATGROUP_AndroidCamera, ANDROIDCAMERA_API);
...
public:
  ...
  void RegisterComponent(UAndroidCameraComponent& Component, int DesiredWidth,
                         int DesiredHeight, int DesiredFPS);
  ...
  bool OnImageAvailable(int CameraId, unsigned char* Y, unsigned char* U,
                        unsigned char* V,
