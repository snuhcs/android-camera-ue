...
void YUV420ToARGB8888(unsigned char* yData, unsigned char* uData,
                      unsigned char* vData, int Width, int Height,
  ...
  for (int j = 0; j < Height; j++) {
    ...
    for (int i = 0; i < Width; i++) {
      ...
      Out[yp++] = YUV2RGB(0xff & yData[pY + i], 0xff & uData[uv_offset],
